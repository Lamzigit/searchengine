...
public class CrawlerController {
    ...
    private VistedFrontier vistedFrontier = new VistedFrontier("visitedDB");

    private TodoFrontier todoFrontier = new TodoFrontier();
    ...
    public void crawler(){
        ...
        while(isInit){
            if(!todoFrontier.isEmpty()){
                ...
                System.out.println("开始线程,当前线程数："+threadnum);
            }
        }
    }
}
